...
<body>
    <form action="paiment" method="post">
<!--///////////////////////php////////////////////////-->
<?php 
...
foreach ($res as $row){
    ...
    <tr> 
    <td class='text-center'><b>Date de paiement  :</b></td>
    ...
    echo"
        ...
        <button type='submit'  class='btn btn-success' data-toggle='modal' data-target='#exampleModal' onclick='page()'>
            Paiement
        </button>
        </td>
